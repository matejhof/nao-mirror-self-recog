...
home_pose1 = [1.117, 0.083, -0.87, -0.02, 1.638, 0, 0, 0, 0, 0, -0.21, -0.12]
home_pose2 = [0, 0, 0, 0, 0, -1.117, -0.083, -0.87, 0.02, -1.638, 0.21, -0.12]
...
explauto_env1 = NaoEnvironment(joint_min, joint_max, [], [], joints, ros_topic1, ee_link_name1, use_reset, total_sensors, skin_map, collision_target_link)
explauto_env2 = NaoEnvironment(joint_min, joint_max, [], [], joints, ros_topic2, ee_link_name2, False, total_sensors, skin_map, collision_target_link)
