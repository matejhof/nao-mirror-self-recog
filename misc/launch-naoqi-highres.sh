...
reset
roslaunch nao_gazebo_plugin nao_gazebo_skin.launch disable_controller:=false nao_version:=$NAO_VERSION contact_torso:=$CONTACT_TORSO contact_head:=$CONTACT_HEAD contact_left_arm:=$CONTACT_LEFT_ARM contact_right_arm:=$CONTACT_RIGHT_ARM
