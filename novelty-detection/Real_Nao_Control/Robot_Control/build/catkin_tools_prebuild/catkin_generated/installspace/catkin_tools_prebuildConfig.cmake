...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'catkin_tools_prebuild' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/deepself/Shengzhi_Project/self-recognize/Owner/Real_Nao_Control/Robot_Control/install/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/deepself/Shengzhi_Project/self-recognize/Owner/Real_Nao_Control/Robot_Control/install/lib;/home/deepself/Shengzhi_Project/nao-mirror-self-recog/catkin_ws/devel/lib;/opt/ros/kinetic/lib)
